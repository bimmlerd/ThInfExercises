...
\begin{homeworkProblem}
	Wir suchen \( R_{13}^3 \cup R_{11}^3 \) \\
	...
	\\
		...
		\begin{tabular}{|l|c|r|}
			...
			\(R_{22}^1 \) & \( (a+c) + \emptyset c^{*} (a+b)\) & \(a+c\) \\
	...
	\\
		...
		\begin {tabular}{|l|c|r|}
			...
			\(R_{33}^2 \) & \( (a + b) + c (a+c)^{*}b \) & \( (a +b) + c (a+c)^{*}b \) \\
			\hline
		\end{tabular}
		\end{center}
	\item \(k = 3\)
	\\
		...
		\begin{tabular}{|l|c|c|}
			...
			\(R_{13}^3 \) & \( (c^{*}(a+b)(a+c)^{*}b) + c^{*}(a + b)(a + c)^{*}b( (a +b) + c (a+c)^{*}b )^{*}  \) & \(c^{*}(a + b)								(a + c)^{*}b( (a +b) + c (a+c)^{*}b )^{*}\) \\
			\hline
		\end{tabular}
		\end{center}
